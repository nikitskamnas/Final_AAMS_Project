 ...
 var colorsDash = ['#04b383', '#01c0c8','#8E37D7','#3b82ac'];
    Morris.Donut({
        element: 'breed-chart',
        colors: colorsDash,
        resize: true,
        labels: ['Series A', 'Series B', 'Series C'],
        data: [
            { label: "Ayrshire", value: 05 },
            { label: "Friesian", value: 20 },
            { label: "Guernesy", value: 20 },          
            { label: "Jersey", value: 20 }
